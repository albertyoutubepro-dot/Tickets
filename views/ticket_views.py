        ...
        try:
                ...
                if not (is_creator or is_support or is_admin):
                    ...
                    embed.add_field(
                        ...
                        value=f"**👤 Ticket Creator:** Original requester\n"
                              f"**🛡️ Support Staff:** {support_role.mention if support_role else 'Support Role'}\n"
            ...
            confirmation_embed = discord.Embed(
                ...
                description=f"**Are you sure you want to close this support ticket?**\n\n"
                           f"⚠️ **Important:** This action is permanent and cannot be undone.\n\n"
                ...
                if claim_result and claim_result[0]:
                    ...
                    embed = discord.Embed(
                        ...
                        description=f"**This ticket has already been claimed and is being handled.**\n\n"
                                   ...
                                   f"🏷️ **Agent Name:** {claimer.display_name if claimer else 'Unknown'}\n"
...
class SetupWizardView(discord.ui.View):
    ...
    async def start_setup(self, interaction):
        ...
        embed.set_footer(text="Setup Wizard • Step 1 of 1")
...
class ConfirmSetupButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        embed.set_footer(text="Configuration Preview")
